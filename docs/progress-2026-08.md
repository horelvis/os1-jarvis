# PROGRESS — agosto de 2026, la era del widget

> **Separado de `PROGRESS.md` el 2026-09-06**, sin editar una coma. Son
> las entradas del 2026-08-23 al 2026-08-30: la tira, el turno de voz,
> las cámaras, el LLM en casa, la delegación de código y el renombrado.
> El índice de todas ellas está en `PROGRESS.md`.
