# PROGRESS — hasta junio de 2026, la era del kiosko

> **Separado de `PROGRESS.md` el 2026-09-06**, sin editar una coma. Es
> la construcción de v1–v3: las fases 0–10, el backend FastAPI, el
> frontend React, la memoria ChromaDB y el kiosko de Chromium. **Nada de
> lo que describe sigue en pie** — `backend/` y `frontend/` se borraron
> el 2026-09-03 y la superficie es la tira desde agosto. Se conserva
> porque el porqué de cada fase sigue explicando decisiones que sí
> siguen vivas. El índice está en `PROGRESS.md`.
