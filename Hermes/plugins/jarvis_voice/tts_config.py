...
unchanged — JARVIS_TTS_COSYVOICE_* — because they are set on the
...
class TTSConfig:
    ...
    # JARVIS_TTS_COSYVOICE_URL=http://<your-gpu-host>:8093
    ...
    def from_env(cls) -> TTSConfig:
        def _get(key: str, default):
            val = os.environ.get(f"JARVIS_TTS_COSYVOICE_{key}")
            if val is None:
                return default
