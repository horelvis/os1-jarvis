...
from Hermes.plugins.jarvis_vision.vision import (
    WATCHED_CLASSES,
    CameraStream,
    Detection,
    Watcher,
...
def test_the_same_thing_again_is_not_news() -> None:
    ...
    three seconds."""
    from Hermes.plugins.jarvis_vision.vision import Watcher
...
def test_the_same_thing_much_later_is_news_again() -> None:
    from Hermes.plugins.jarvis_vision.vision import ANTI_SPAM_SECONDS, Watcher
...
def test_quiet_hours_wrap_around_midnight() -> None:
    from Hermes.plugins.jarvis_vision.vision import is_quiet_hours
...
def test_the_threshold_matches_what_the_cameras_taught_barndoor() -> None:
    ...
    cameras settled on."""
    from Hermes.plugins.jarvis_vision.vision import DEFAULT_THRESHOLD
